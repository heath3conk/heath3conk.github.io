...
// Goals: Interact with the user on my website so that the user can guess letters
//      and use their position in the word to guess the full word.
...
// I have this working via the terminal - with no user interaction. This is the outline
// for what it should do on the website:

// When the page loads, it shows the completed hangman (gameOver img file) and a button
// that reads "start a new game"

// When the user clicks on the button, the following things should happen:
...
Start a new game:
    Remove/hide the gameOver image from the screen. 
...
Play a turn: The types a letter into the prompt.
	
	Invoke the examine_word function (takes the game_word and the user's input as arguments)
	...
	Invoke the game_over? function
		...
		Else no change to the value of 'game_over?' and prompt the user for another guess
